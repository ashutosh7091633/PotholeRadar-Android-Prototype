  ...
  return (
    <Frame>
      ...
      <div className="absolute left-[5.5vw] top-[36vh] w-[33vw]">
        ...
        <div className="mt-[1vh] text-[1.4vw] font-semibold uppercase tracking-[0.16em] text-muted">candidate impact threshold</div>
        ...
        <div className="mt-[1vh] flex w-[26vw] justify-between text-[0.95vw] font-semibold uppercase tracking-[0.12em] text-muted"><span>MINOR</span><span>MODERATE</span><span>SEVERE</span></div>
      </div>
